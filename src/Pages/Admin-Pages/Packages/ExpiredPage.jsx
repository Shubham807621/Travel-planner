...
const initialData = [
  { name: "Singapore Holiday Tour", date: "12 May", destination: "Japan", status: "Expired" },
  { name: "New Year's Eve in Paris", date: "12 May", destination: "Japan", status: "Expired" },
  { name: "Paris Honeymoon Tour", date: "12 May", destination: "Japan", status: "Expired" },
  { name: "Japan Holiday Tour", date: "12 May", destination: "Japan", status: "Expired" },
  { name: "California Trip", date: "12 May", destination: "Japan", status: "Expired" },
  { name: "Dubai Tour", date: "12 May", destination: "Japan", status: "Expired" }
];
    ...
    <tr key={actualIndex} className={actualIndex % 2 === 0 ? "even-row" : ""}>
      {editIndex === actualIndex ? (
        ...
        <>
          ...
          <td><span className="status-expired">{pkg.status}</span></td>
          <td>
