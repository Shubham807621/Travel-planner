...
const initialData = [
  { name: "Singapore Holiday Tour", date: "12 May", destination: "Japan", status: "Pending" },
  { name: "New Year's Eve in Paris", date: "12 May", destination: "Japan", status: "Pending" },
  { name: "Paris Honeymoon Tour", date: "12 May", destination: "Japan", status: "Pending" },
  { name: "Japan Holiday Tour", date: "12 May", destination: "Japan", status: "Pending" },
  { name: "California Trip", date: "12 May", destination: "Japan", status: "Pending" },
  { name: "Dubai Tour", date: "12 May", destination: "Japan", status: "Pending" }
];
